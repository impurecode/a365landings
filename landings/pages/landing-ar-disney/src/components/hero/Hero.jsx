...
const Hero = () => {
  ...
  const textToShow =
    "Planificar un viaje a Disney desde Argentina es un sueño para muchas familias. Muchos desean viajar al estado de Florida para conocer estos asombrosos parques temáticos, y pasar momentos inolvidables junto a sus seres queridos. Sin embargo, existe mucho desconocimiento sobre los costos asociados al viaje, sobre todo porque la cotización del dólar varía con mucha frecuencia, y no se sabe cuántos pesos se necesitan para lograrlo. En este artículo te contamos cuánto necesitas para viajar a Disney y convertir ese sueño en una realidad.";
          ...
          <div className='w-full max-w-[358px] sm:max-w-[633px] xl:max-w-[1210px] px-4 flex flex-col xl:flex-row '>
            <div>
              <h1 className=' leading-[52px] text-white font-titillium font-bold text-[30px] md:text-4xl lg:text-5xl xl:text-[64px] mt-9 md:mt-[103px] text-center md:text-left'>
                Descubre en cuánto sale un viaje a Disney desde Argentina
              </h1>
