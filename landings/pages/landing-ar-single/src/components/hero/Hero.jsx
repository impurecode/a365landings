...
const Hero = () => {
  ...
  const textToShow =
    "Viajar solo es una experiencia que muchas personas consideran enriquecedora y transformadora. Esta aventura no solo permite explorar nuevos lugares, sino también descubrir más sobre uno mismo. En este artículo, exploraremos los beneficios de viajar solo, los mejores lugares para viajar solo, y algunos destinos para viajar solo por primera vez.";
