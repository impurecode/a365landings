...
const Hero = () => {
  ...
  const textToShow = 'Brasil es uno de los países más populares para el turismo debido a sus impresionantes paisajes, su cultura rica y diversa, su gastronomía deliciosa y sus festivales vibrantes. Acá podés conocer algunos lugares turísticos que no puedes dejar de visitar si tenés la oportunidad de viajar a Brasil. A continuación te mencionaremos 5 lugares para visitar en Brasil que no debes perderte. Son lugares ideales para irte de vacaciones. Desde destinos de playa para relajarse y disfrutar de la vida nocturna, hasta ciudades emblemáticas con mucha historia y puntos de interés por conocer.';
        ...
        <div className="hero-content flex flex-col items-center justify-center mx-auto">
          <div className="w-full max-w-[358px] sm:max-w-[633px] xl:max-w-[1210px] px-4 flex flex-col xl:flex-row ">
            <div>
              ...
              Ciudades y Lugares Turísticos de Brasil
              </h1>
