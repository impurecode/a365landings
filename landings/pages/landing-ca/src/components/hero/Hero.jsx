...
const Hero = () => {
  ...
  const textToShow = 'Si estás planeando visitar Canadá, ya sea para turismo, estudios o trabajo, es probable que necesites obtener una visa antes de viajar. El proceso de selección de inmigrantes se basa en las habilidades y experiencia laboral de las personas, así como en cómo pueden contribuir al crecimiento económico del país o ayudar en la reunificación familiar.  A continuación te brindaremos toda la información que necesitás saber para solicitar la visa canadiense.';
        ...
        <div className="hero-content flex flex-col items-center justify-center mx-auto">
          <div className="w-full max-w-[358px] sm:max-w-[633px] xl:max-w-[1210px] px-4 flex flex-col xl:flex-row ">
            <div>
              ...
              Visa canadiense para argentinos
              </h1>
