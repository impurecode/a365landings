...
const Hero = () => {
  ...
  const textToShow =
    "Viajar a Argentina desde Chile puede ser una experiencia emocionante y enriquecedora. Sin embargo, es importante estar preparado para cualquier eventualidad, especialmente en términos de salud y seguridad.  En esta guía, te explicaremos todo lo que necesitas saber sobre el seguro de viaje para Argentina, incluyendo por qué es necesario, cómo elegir el mejor seguro y las opciones disponibles en el mercado. Viajá tranquilo y protegido con ASSIST 365.";
          ...
          <div className='w-full max-w-[358px] sm:max-w-[633px] xl:max-w-[1210px] px-4 flex flex-col xl:flex-row '>
            <div>
              <h1 className=' leading-[52px] text-white font-titillium font-bold text-[30px] md:text-4xl lg:text-5xl xl:text-[64px] mt-9 md:mt-[103px] text-center md:text-left'>
                Seguro de viaje para Argentina: guía completa
              </h1>
