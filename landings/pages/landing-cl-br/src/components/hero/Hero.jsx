...
const Hero = () => {
  ...
  const textToShow =
    "Viajar a Brasil es una experiencia emocionante, llena de paisajes impresionantes y cultura vibrante. Sin embargo, para disfrutar plenamente de tu viaje, es crucial contar con un seguro de viaje adecuado. Un seguro de viaje a Brasil no sólo te brinda tranquilidad, sino que también te protege ante imprevistos médicos y otros problemas que puedan surgir durante tu aventura. En este artículo, explicaremos por qué es esencial tener un seguro de viaje, cómo elegir el mejor para ti y cuáles son las opciones más económicas disponibles.";
          ...
          <div className='w-full max-w-[358px] sm:max-w-[633px] xl:max-w-[1210px] px-4 flex flex-col xl:flex-row '>
            <div>
              <h1 className=' leading-[52px] text-white font-titillium font-bold text-[30px] md:text-4xl lg:text-5xl xl:text-[64px] mt-9 md:mt-[103px] text-center md:text-left'>
                Seguro de viaje a Brasil: todo lo que debes saber
              </h1>
