...
const Hero = () => {
  ...
  const textToShow =
    "Viajar es una experiencia enriquecedora que nos permite conocer nuevas culturas y lugares. Sin embargo, para disfrutar al máximo de tu viaje es fundamental contar con un seguro de viaje internacional. En esta guía, te ayudaremos a entender la importancia de un seguro de viaje, cómo elegir el mejor para tus necesidades y responderemos las preguntas más frecuentes sobre el tema.";
          ...
          <div className='w-full max-w-[358px] sm:max-w-[633px] xl:max-w-[1210px] px-4 flex flex-col xl:flex-row '>
            <div>
              <h1 className=' leading-[52px] text-white font-titillium font-bold text-[30px] md:text-4xl lg:text-5xl xl:text-[64px] mt-9 md:mt-[103px] text-center md:text-left'>
                Seguro de viaje internacional: ¿por qué es importante tener uno?
              </h1>
