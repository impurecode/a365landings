  ...
  return (
    <>
      ...
      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12 px-4 '>
        ...
        <p className='px-4'>
          Existen diferentes tipos de visa de trabajo en España, y cada una
          tiene sus propios requisitos y condiciones. Los tipos más comunes de
          visa de trabajo son:
        </p>
      </div>
      ...
      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12 px-4 '>
        <h2 className='font-bold text-blue-primary text-center font-titillium text-3xl sm:text-4xl xl:text-6xl mb-12 mt-6'>
          Beneficios de viajar a España con una asistencia al viajero
        </h2>

        <div className='video-container max-w-[793px] mx-auto h-full px-4'>
          <iframe
            width='100%'
            src='https://www.youtube.com/embed/s1ePaji6O2o?si=6VLGxRvyviQFgkvP'
