    ...
    <>
      ...
      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12'>
        <h2 className='font-bold text-blue-primary text-center font-titillium text-3xl sm:text-4xl xl:text-6xl mb-12 mt-6'>
          ETIAS: la nueva visa para ingresar a Europa
        </h2>
        Te dejamos toda la información que precisas saber sobre este nuevo
        permiso que será implementado próximamente para el ingreso a la Unión
        Europea.
      </div>
      ...
      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12 '>
        ...
        <div className='video-container max-w-[793px] mx-auto h-full px-4'>
          <iframe
            width='100%'
            src='https://www.youtube.com/embed/s1ePaji6O2o?si=TtKBsaciZfItPGym'
