...
const Hero = () => {
  ...
  const textToShow = 'Ante la pandemia por coronavirus (COVID-19) provocada por el virus SARS-CoV-2, las vacunas se han vuelto indispensables para generar una inmunidad contra enfermedades como: fiebre, tos, dolor de garganta, rinitis / congestión nasal, dolor muscular, cefalea, diarrea y/o vómitos. Su forma de administración es mediante una inyección intramuscular que pueden causar efectos secundarios dependiendo de la marca administrada.  La región Europea para proteger a su población exige una serie de vacunas para poder ingresar a sus países, por lo que es necesario que antes de organizar tu viaje al continente europeo conozcas cuales son las vacunas aprobadas para entrar a cualquier país de la región.';
        ...
        <div className="hero-content flex flex-col items-center justify-center mx-auto">
          <div className="w-full max-w-[358px] sm:max-w-[633px] xl:max-w-[1210px] px-4 flex flex-col xl:flex-row ">
            <div>
              ...
              ¿Cuáles son las vacunas aceptadas en Europa? 
              </h1>
