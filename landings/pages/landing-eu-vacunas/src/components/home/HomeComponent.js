  ...
  return (
    <>
      ...
      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12'>
        ...
        Vacunas permitidas en europa
        </h2>
        Al realizar viajes internacionales debes cumplir con una serie de requisitos, entre ellos vacunas para poder ingresar al país como medida preventiva y una estancia sin complicaciones. Te dejamos la información que precisas saber para planificar tu viaje a Europa y no tener inconvenientes en el ingreso.
      </div>
      ...
      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12 '>
        ...
        <div className="video-container max-w-[793px] mx-auto h-full px-4">
          <iframe
            ...
            src="https://www.youtube.com/embed/s1ePaji6O2o?si=x5OHq_sQYkMXE18O"
