...
const Hero = () => {
  ...
  const textToShow = '¡Descubrí la magia de Francia! Un destino que encanta a personas de todo el mundo. Francia ofrece una combinación perfecta de historia, cultura, gastronomía y paisajes impresionantes. A continuación te brindaremos toda la información necesaria para viajar desde Argentina hasta Francia, de esta forma podrás planificar tu próxima aventura europea.';
