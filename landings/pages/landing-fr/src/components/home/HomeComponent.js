  ...
  return (
    <>
      ...
      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12 px-4 '>
        ...
        ¿Qué se necesita para viajar a Francia siendo argentino?
        </h2>
         <p className='px-4'>Viajar desde Argentina hasta Francia es una experiencia emocionante y llena de posibilidades. La forma más común de llegar es a través del transporte aéreo. Pero antes de esto, te contaremos los requisitos principales para una entrada al país francés satisfactoria. </p> 
      ...
      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12 px-4 '>
        <h2 className="font-bold text-blue-primary text-center font-titillium text-3xl sm:text-4xl xl:text-6xl mb-12 mt-6 px-4">
        ¿Se necesita seguro médico para viajar a Francia?
        </h2>
        <p className='px-4'>Si estás planeando un viaje a la encantadora París y sus pueblos encantadores, es necesario contratar un seguro de viaje al visitar Francia es una decisión inteligente y responsable. Aunque no es obligatorio, tener un seguro de viaje brinda tranquilidad y protección en caso de imprevistos, como necesitar asistencia y repatriación médica, ayuda con la cancelación de viaje o pérdida o retraso de equipaje. 
      ...
      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12 px-4 '>
        ...
        Beneficios de viajar a Francia con asistencia al viajero
        </h2>
        ...
        <div className="video-container max-w-[793px] mx-auto h-full px-4">
          <iframe
            ...
            src="https://www.youtube.com/embed/s1ePaji6O2o?si=tsD7VzFZM10CO230"
      ...
      <div className="w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] px-4">
        ...
        Cotiza tu seguro de viaje a Francia
        </h2>
      </div>
