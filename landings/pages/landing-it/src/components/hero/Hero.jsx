...
const Hero = () => {
  ...
  const textToShow = 'Italia es un país rico en historia, arte, arquitectura, gastronomía y estilo de vida. Es un destino turístico popular en Europa y en todo el mundo debido a su patrimonio cultural y belleza natural. Si planeas visitar Italia, ya sea por turismo, estudio o trabajo, es importante que conozcas los requisitos para viajar a este país.Te detallamos los requisitos más importantes. ';
        ...
        <div className="hero-content flex flex-col items-center justify-center mx-auto">
          <div className="w-full max-w-[358px] sm:max-w-[633px] xl:max-w-[1210px] px-4 flex flex-col xl:flex-row ">
            <div>
              ...
              Requisitos para viajar a Italia desde Argentina
              </h1>
