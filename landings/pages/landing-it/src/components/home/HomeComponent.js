  ...
  return (
    <>
      ...
      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12 px-4 '>
        ...
        ¿Qué requisitos se necesita para viajar a italia?
        </h2>
        {/* <p className='px-4'>Existen diferentes tipos de visa de trabajo en España, y cada una tiene sus propios requisitos y condiciones. Los tipos más comunes de visa de trabajo son:</p> */}
      ...
      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12 px-4 '>
        <h2 className="font-bold text-blue-primary text-center font-titillium text-3xl sm:text-4xl xl:text-6xl mb-12 mt-6 px-4">
        ¿Es necesario presentar una carta de invitación?
        </h2>
        <p className='px-4'>En Italia, la carta de invitación es una declaración jurada que no requiere la firma o la confirmación de ninguna institución, a diferencia de la carta de invitación para España. Esta carta se utiliza para demostrar que alguien en Italia te ofrecerá alojamiento durante tu estancia en el país. Es necesaria solo para aquellos que planean alojarse en casa de amigos o familiares en Italia, mientras que si te hospedas en un hotel no es necesario presentarla.</p> 
       
      </div>

      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12 px-4 '>
        <h2 className="font-bold text-blue-primary text-center font-titillium text-3xl sm:text-4xl xl:text-6xl mb-12 mt-6">
        Beneficios de viajar a Italia con asistencia al viajero
        </h2>
        ...
        <div className="video-container max-w-[793px] mx-auto h-full px-4">
          <iframe
            ...
            src="https://www.youtube.com/embed/s1ePaji6O2o?si=qoS6wuatz66r76Qg"
      ...
      <div className="w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] px-4">
        ...
        Cotiza tu seguro de viaje para Italia
        </h2>
      </div>
