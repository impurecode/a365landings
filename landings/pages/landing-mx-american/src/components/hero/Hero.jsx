...
const Hero = () => {
  ...
  const textToShow =
    "Obtener una visa para viajar a Estados Unidos trae consigo una serie de ventajas. Te permite explorar sus ciudades, parques nacionales y atracciones culturales. Además, con una visa americana B1/B2 puedes asistir a conferencias, ferias comerciales y encuentros profesionales. Una visa abre las puertas a nuevas experiencias, conexiones y descubrimientos en tierras estadounidenses. Para obtenerla es necesario seguir una serie de requisitos.";
