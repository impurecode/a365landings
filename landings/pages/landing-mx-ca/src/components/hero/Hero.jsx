...
const Hero = () => {
  ...
  const textToShow =
    "Viajar a Canadá desde México es una experiencia emocionante que ofrece a los viajeros la oportunidad de explorar un país lleno de paisajes impresionantes, rica historia y una cultura diversa. Sin embargo, antes de embarcarte en tu aventura canadiense, es importante conocer los requisitos necesarios para ingresar al país.";
