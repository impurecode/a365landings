...
const Hero = () => {
  ...
  const textToShow = 'Viajar a España desde México es una experiencia emocionante y llena de oportunidades para explorar un país rico en cultura, historia y belleza. Sin embargo, antes de emprender tu viaje, es fundamental conocer los requisitos necesarios para garantizar un viaje sin contratiempos.';
