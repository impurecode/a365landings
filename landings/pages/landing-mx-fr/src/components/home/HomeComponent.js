    ...
    <>
      ...
      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12 px-4 '>
        <h2 className='font-bold text-blue-primary text-center font-titillium text-3xl sm:text-4xl xl:text-6xl mb-12 mt-6 px-4'>
          ¿Qué se necesita para viajar a Francia?
        </h2>
        <p className='px-4 text-center'>
          Cumplir con estos requisitos te permitirá disfrutar de un viaje a
          Francia desde México tranquilo y sin contratiempos.Te recomendamos
          revisar cuáles son los{" "}
          <a
            href='https://assist-365.com/mx/requisitos/requisitos-para-pasaporte-mexicano'
            className='text-blue-500 underline'
          >
            requisitos para el pasaporte mexicano
          </a>{" "}
          , ya que este documento es indispensable tanto para viajar a Francia
          como a cualquier otro país
        </p>
      </div>
      ...
      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12 px-4 '>
        <h2 className='font-bold text-blue-primary text-center font-titillium text-3xl sm:text-4xl xl:text-6xl mb-12 mt-6'>
          Beneficios del seguro de viaje en Francia
        </h2>
        <h3 className='px-4 text-center mb-12'>
          {" "}
          El seguro de viaje en Francia ofrece una invaluable tranquilidad y
          protección para los viajeros. Al contar con este seguro, los
          visitantes estarán cubiertos ante cualquier eventualidad médica,
          evitando gastos inesperados en caso de accidentes o enfermedades
          durante su estadía.
        </h3>
        ...
        <div className='video-container max-w-[793px] mx-auto h-full px-4'>
          <iframe
            width='100%'
            src='https://www.youtube.com/embed/s1ePaji6O2o?si=ZKP-lMkwSZjVjdCA'
