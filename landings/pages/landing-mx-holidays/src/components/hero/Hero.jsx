...
const Hero = () => {
  ...
  const textToShow = 'Viajar en días festivos siempre es una buena manera de sacar provecho del tiempo libre, sirve para escapar de la rutina y explorar nuevos destinos. De acuerdo con el calendario oficial, los días de descanso obligatorio 2023 en México incluyen siete días festivos no laborables y cinco puentes. Además, al viajar en estas fechas puedes encontrar ofertas especiales en hoteles y actividades, lo que te permite ahorrar dinero.';
        ...
        <div className="hero-content flex flex-col items-center justify-center mx-auto">
          <div className="w-full max-w-[358px] sm:max-w-[633px] xl:max-w-[1210px] px-4 flex flex-col xl:flex-row ">
            <div>
              ...
              Recomendaciones para viajar durante días festivos
              </h1>
