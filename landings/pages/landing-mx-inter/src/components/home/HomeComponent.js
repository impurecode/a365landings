    ...
    <>
      ...
      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12 px-4 '>
        ...
        <p className='px-4 text-center'>
          {" "}
          El seguro de viaje internacional es un tipo de póliza diseñada para
          brindar protección y asistencia a los viajeros que se desplazan fuera
          de su país de origen. Cubre una variedad de situaciones imprevistas,
          como emergencias médicas, pérdida de equipaje, cancelación de viajes,
          retrasos, evacuación médica y responsabilidad civil.
        </p>
      </div>
      ...
      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12 px-4 '>
        ...
        <h3 className='px-4 text-center mb-12'>
          ...
          El{" "}
          <a
            href='https://assist-365.com/mx/destinos/seguro-de-viaje-a-europa'
            className='text-blue-500 underline'
          >
            seguro de viaje para Europa
          </a>{" "}
          o cualquier otro lugar del mundo, te podemos ayudar. En el siguiente
          video te explicamos qué debes tener en cuenta al momento de contratar
          un seguro o asistencia de viaje
        </h3>
        <div className='video-container max-w-[793px] mx-auto h-full px-4'>
          <iframe
            width='100%'
            src='https://www.youtube.com/embed/Tml-p8AXd_g?si=tAqo_vp1uJLugDSd'
