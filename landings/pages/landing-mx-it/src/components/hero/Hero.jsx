...
const Hero = () => {
  ...
  const textToShow =
    "Italia, ubicada en el corazón del Mediterráneo, es un país fascinante y cautivador con una rica historia y cultura que abarca más de dos milenios. Si estás planeando un emocionante viaje a Italia desde México, es esencial que te mantengas informado sobre los requisitos y documentos necesarios para asegurar un viaje sin contratiempos. A continuación, te presentamos los puntos clave que debes tener en cuenta antes de emprender tu aventura.";
