    ...
    <>
      ...
      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12 px-4 '>
        <h2 className='font-bold text-blue-primary text-center font-titillium text-3xl sm:text-4xl xl:text-6xl mb-12 mt-6 px-4'>
          ¿Qué se necesita para viajar a Italia desde México?
        </h2>
        <p className='px-4 text-center'>
          Italia es un país con una rica historia, impresionante cultura y
          deliciosa gastronomía, por lo que una vez que tengas todo en orden,
          estarás listo para disfrutar de una experiencia inolvidable en esta
          maravillosa nación europea.{" "}
        </p>
      </div>
      ...
      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12 px-4 '>
        <h2 className='font-bold text-blue-primary text-center font-titillium text-3xl sm:text-4xl xl:text-6xl mb-12 mt-6'>
          ¿Es obligatorio el seguro de viaje para entrar a Italia?
        </h2>
        <h3 className='px-4 text-center mb-12'>
          {" "}
          Aunque no es un requisito obligatorio, contar con un{" "}
          <a
          ...
          que cubra gastos médicos y repatriación en caso de emergencias es
          altamente recomendado. La atención médica en Italia puede ser costosa
          para los extranjeros, por lo que estar protegido te brindará
          tranquilidad durante tu visita.
        </h3>

        <div className='video-container max-w-[793px] mx-auto h-full px-4'>
          <iframe
            width='100%'
            src='https://www.youtube.com/embed/s1ePaji6O2o?si=p5qODArZim2Zs1_V'
      ...
      <div className=' w-full flex flex-col items-center bg-quoter-landscape '>
        <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] px-4'>
          <h2 className='font-bold text-white md:text-blue-primary text-center font-titillium text-3xl sm:text-4xl xl:text-6xl mb-12 mt-6'>
            Cotiza tu seguro de viaje a Italia
          </h2>
        </div>
