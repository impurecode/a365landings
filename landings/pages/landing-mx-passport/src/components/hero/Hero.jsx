...
const Hero = () => {
  ...
  const textToShow =
    "El pasaporte mexicano es un documento esencial para los ciudadanos que deseen viajar al extranjero y explorar nuevos países. Este valioso documento no solo garantiza la identificación del titular, sino que también permite el acceso a una amplia gama de países. Si estás considerando obtener tu pasaporte mexicano, es importante que estés al tanto de los requisitos necesarios para solicitarlo.";
