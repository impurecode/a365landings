...
const Hero = () => {
  ...
  const textToShow = 'Si estás planeando un viaje a Estados Unidos desde Argentina, es importante que conozcas los requisitos necesarios para ingresar al país. A continuación, te proporcionaremos información sobre los principales requisitos para viajar a Estados Unidos desde Argentina.';
        ...
        <div className="hero-content flex flex-col items-center justify-center mx-auto">
          <div className="w-full max-w-[358px] sm:max-w-[633px] xl:max-w-[1210px] px-4 flex flex-col xl:flex-row ">
            <div>
              ...
              Requisitos para viajar a Estados Unidos desde Argentina
              </h1>
