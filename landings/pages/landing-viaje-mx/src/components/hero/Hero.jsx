...
const Hero = () => {
  ...
  const textToShow = 'México es un destino turístico muy popular para los viajeros de todo el mundo, incluidos los argentinos. Si planeas viajar a México desde Argentina, hay algunos aspectos que debes tener en cuenta para que tu viaje sea lo más seguro y placentero posible.Antes de planificar tu itinerario hacia la variedad de opciones de turismo para disfrutar, tené en cuenta estos requisitos para viajar a México.';
