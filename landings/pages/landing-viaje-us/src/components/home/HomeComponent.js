  ...
  return (
    <>
      ...
      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12 px-4 '>
        ...
        ¿Qué tan necesario es el seguro de viaje para entrar a Estados Unidos?
        </h2>
         <p className='px-4'>  Existen países que exigen presentar un seguro de viaje para entrar al
          territorio de forma legal y segura, por lo que descubriremos si
          Estados Unidos es uno de ellos.</p> 
      ...
      <div className='w-full mx-auto max-w-[358px] sm:max-w-[633px] xl:max-w-[960px] mt-12 mb-12 px-4 '>
        ...
        <p className='px-4'>     Aunque no es obligatorio, se recomienda que los viajeros obtengan un
        seguro de viaje adecuado para protegerse contra cualquier eventualidad
        que puedan enfrentar durante su viaje.</p> 
