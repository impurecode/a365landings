...
const Hero = () => {
  ...
  const textToShow = 'La asistencia al viajero VISA es un servicio que brinda protección y asistencia durante los viajes a los titulares de tarjetas VISA, ofreciendo una red de apoyo y recursos en caso de emergencias y situaciones imprevistas que puedan surgir durante el viaje.';
        ...
        <div className="hero-content flex flex-col items-center justify-center mx-auto">
          <div className="w-full max-w-[358px] sm:max-w-[633px] xl:max-w-[1210px] px-4 flex flex-col xl:flex-row ">
            <div>
              ...
              ¿Qué es asistencia al viajero VISA?
              </h1>
