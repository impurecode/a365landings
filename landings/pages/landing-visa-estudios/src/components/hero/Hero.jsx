...
const Hero = () => {
  ...
  const textToShow = 'España es un destino popular para estudiantes internacionales debido a una serie de beneficios que ofrece, entre los que se incluyen un Sistema Educativo de alta calidad, Cultura y Patrimonios, excelente ubicación geográfica con un clima agradable de 4 estaciones, Oportunidades de Trabajo y una vida social vibrante. Si estás interesado en estudiar en España, es posible que necesites obtener una visa de estudiante. A continuación, te explicaremos paso a paso cómo sacar la visa para estudiar en España.';
        ...
        <div className="hero-content flex flex-col items-center justify-center mx-auto">
          <div className="w-full max-w-[358px] sm:max-w-[633px] xl:max-w-[1210px] px-4 flex flex-col xl:flex-row ">
            <div>
              ...
              ¿Cómo obtener la visa de estudios en España? 
              </h1>
